...
class suspendAction extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'auto:suspend';
     ...
     * @var string
     */
    protected $description = 'suspend distributor & consultant based on start date';
    ...
    {
        $suspend= DB::table('distributor_management.SUSPEND_REVOKE')
