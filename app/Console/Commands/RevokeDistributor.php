...
class revokeAction extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'auto:revoke';
     ...
     * @var string
     */
    protected $description = 'Terminate distributor & consultant based on effective date';
    ...
    {
        $revoke= DB::table('distributor_management.SUSPEND_REVOKE')
