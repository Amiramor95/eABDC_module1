...
class CreateDIVESTMENTAPPROVALTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DIVESTMENT_APPROVAL', function (Blueprint $table) {
            $table->integer('DIVE_APPR_ID', true);
    ...
    {
        Schema::dropIfExists('DIVESTMENT_APPROVAL');
    }
}
