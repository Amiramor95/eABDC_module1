...
class CreateDISTRIBUTORDIRECTORTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DISTRIBUTOR_DIRECTOR', function (Blueprint $table) {
            $table->integer('DIST_DIR_ID', true);
    ...
    {
        Schema::dropIfExists('DISTRIBUTOR_DIRECTOR');
    }
}
