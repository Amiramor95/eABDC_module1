...
class CreateCESSATIONDISTRIBUTORDOCTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('CESSATION_DISTRIBUTOR_DOC', function (Blueprint $table) {
            $table->integer('CD_DOCUMENT_ID', true);
    ...
    {
        Schema::dropIfExists('CESSATION_DISTRIBUTOR_DOC');
    }
}
