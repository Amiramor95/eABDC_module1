...
class CreateDISTRIBUTORTEMPDETAILINFOTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DISTRIBUTOR_TEMP_DETAIL_INFO', function (Blueprint $table) {
            $table->integer('DIST_TEMP_INFO_ID', true);
            $table->integer('DIST_TEMP_ID');
            $table->string('DIST_PAID_UP_CAPITAL', 100)->nullable()->default('-');
    ...
    {
        Schema::dropIfExists('DISTRIBUTOR_TEMP_DETAIL_INFO');
    }
}
