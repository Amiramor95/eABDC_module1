...
class CreateSUSPENDREVOKEAPPEALAPPRDOCTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SUSPEND_REVOKE_APPEAL_APPRDOC', function (Blueprint $table) {
            $table->integer('SR_APPRD_ID', true);
    ...
    {
        Schema::dropIfExists('SUSPEND_REVOKE_APPEAL_APPRDOC');
    }
}
