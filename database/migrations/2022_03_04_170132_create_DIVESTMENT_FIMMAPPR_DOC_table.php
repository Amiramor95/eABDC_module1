...
class CreateDIVESTMENTFIMMAPPRDOCTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DIVESTMENT_FIMMAPPR_DOC', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('DIVESTMENT_FIMMAPPR_DOC');
    }
}
